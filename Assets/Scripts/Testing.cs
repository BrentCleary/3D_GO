...
{
    [SerializeField] private HeatMapVisualClass heatMapVisual;
    private GridClass grid;

    private void Start()
    {
        grid = new GridClass(10, 5, 10f, Vector3.zero);
    ...
    // TODO - Script from Original GridClass Video - https://www.youtube.com/watch?v=waEsGu--9P8&t=18s
    // private GridClass grid;
